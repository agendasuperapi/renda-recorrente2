  ...
  public: {
    Tables: {
      ...
      training_lesson_favorites: {
        ...
        Relationships: [
          {
            foreignKeyName: "training_lesson_favorites_lesson_id_fkey"
            columns: ["lesson_id"]
            isOneToOne: false
            referencedRelation: "training_lessons"
            referencedColumns: ["id"]
      ...
      training_lessons: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["training_id"]
            isOneToOne: false
            referencedRelation: "view_training_stats"
      ...
      training_ratings: {
        ...
        Relationships: [
          {
            foreignKeyName: "training_ratings_training_id_fkey"
            columns: ["training_id"]
            isOneToOne: false
            referencedRelation: "trainings"
            referencedColumns: ["id"]
