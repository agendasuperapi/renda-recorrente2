...
const AdminUserActivitiesContent = lazy(() => import("./AdminUserActivities"));
  ...
  return (
    ...
    <div className="w-full p-3 md:p-6 space-y-4 md:space-y-6">
      ...
      <Tabs defaultValue="environment" className="w-full">
        <TabsList className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-12 gap-2 bg-muted/50 p-1.5 rounded-xl">
          ...
          <TabsTrigger value="activities" className="flex items-center justify-center gap-1.5 px-2 py-2.5 text-xs sm:text-sm font-medium">
        ...
        <TabsContent value="activities" className="mt-4">
          <Suspense fallback={<TabLoadingFallback />}>
            <AdminUserActivitiesContent isEmbedded />
          </Suspense>
        </TabsContent>
