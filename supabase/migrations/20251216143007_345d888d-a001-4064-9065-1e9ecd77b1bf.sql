-- Recriar view_referrals buscando avatar_url diretamente de profiles
...
-- Remover coluna avatar_url de unified_users (não é necessária)
ALTER TABLE public.unified_users DROP COLUMN IF EXISTS avatar_url;