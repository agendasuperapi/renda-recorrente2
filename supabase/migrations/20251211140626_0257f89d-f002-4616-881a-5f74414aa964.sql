-- Atualizar função para gerar comissões de pagamentos importados com affiliate_id direto
...
COMMENT ON FUNCTION public.generate_commission_from_unified_payment() IS 
  'Gera comissões automaticamente quando um pagamento unificado é inserido. Suporta hierarquia de sub_affiliates e fallback para affiliate_id direto em pagamentos importados.';